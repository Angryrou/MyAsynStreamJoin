...
import mypartitioner.StateRoundRobinPartitioner
...
object RoundRobinJoin {
  ...
  def main(args: Array[String]) {
    ...
    val sc = new SparkConf().setAppName("RoundRobinJoin_state")
    ...
    def mappingFuncRR(partitionId: Int, word: String, one: Option[(Int, BigInt)],
